class Instruction:
    ...
    def controlArg(self):
        ...
        if self.opcode in ["MOVE", "NOT", "INT2CHAR", "READ", "STRLEN", "TYPE"]:
            if self.arg1 == None or self.arg2 == None or self.arg3 != None:
                exit(32)
                
        if self.opcode in ["ADD", "SUB", "MUL", "IDIV", "LT", "GT", "EQ", "AND", "OR", "STRI2INT", "CONCAT", "GETCHAR", "SETCHAR", "JUMPIFEQ", "JUMPIFNEQ"]:
            if self.arg1 == None or self.arg2 == None or self.arg3 == None:
                exit(32)